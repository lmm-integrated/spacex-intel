...
_Refresh 2026-06-29: the inaugural bond **priced** (see below) at $25B across 5 tranches on Jun 23, settled Jun 26. SPCX kept sliding, $165.78 -> $153.23 (~$2.02T cap), down ~16% on the week, as the market digested the debt layered onto the cash-burning AI segment, even through positive model/product news. Also landed: **Grok 4.5** (on the 1.5T V9 foundation, Cursor data in training) entered **private beta** at SpaceX & Tesla Jun 28, and the **Cursor iOS app** launched Jun 29 (see [05](05-cursor-anysphere.md), [06](06-grok.md)). Still pending: FAA Flight 12 investigation (Flight 13 targeted ~Jul 3); Cursor deal close (Q3); the 6T Grok 5 (Q2 window closing). See [10-catalyst-calendar.md](10-catalyst-calendar.md)._

...
- **Timing:** Vera Rubin (VR200 / Vera Rubin NVL72) hit full production per CES Jan 2026; first samples shipped ~Feb 2026; volume ships H2 2026 ("this fall"). As of late June 2026, trade press reports Rubin mass production is finalized with first deliveries to North American tech giants targeted for **July 2026** (server partners + major cloud/AI labs including xAI named among recipients). Volumes stay thin: ~30,000 units in 2026, ~100,000 in 2027 (2026 ceiling ~200,000-300,000). It is still **HBM4-constrained** (SK Hynix reportedly slipped its HBM4 ramp Q2->Q3 2026; TrendForce cut Rubin's 2026 share from 29% to 22%), so broad availability is "Q4 2026 at the earliest." Earliest realistic xAI Rubin deployment is late 2026/2027. Colossus 2 today is Blackwell (GB200/GB300), not Rubin.
